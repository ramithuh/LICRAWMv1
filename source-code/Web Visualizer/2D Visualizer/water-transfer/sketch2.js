...
function setup() {
  ...
  gui = createGui('LICRAWM Water Transfer Visualizer');
...
function gotData() {
 ...
 if(visualizationLog.length>40){
  ...
  if(currentString[0]=='T'){
    ...
    m1_encoder_count=parseInt(latestData[17]);
    m2_encoder_count=parseInt(latestData[19]);
  
    visualizationLog.unshift(latestData.slice(15,19));
